...
function setup(){
    ...
    generateClouds(50, 300, 300, 0.8, 4500, 800);
    generateClouds(400, 100, 250, 1.5, 4500, 400);
    ...
    min_spawn_distance: 250, // Минимальное расстояние от игрока
    max_spawn_distance: 500, // Максимальное расстояние от игрока
    enemy_x: 0,
    ...
    drawShadow: function() {
        if (gameItem.picked_up && !this.wasCreated){
            ...
            if (this.game_start && !this.enemy_dead && !window_object.game_over){
                ...
                if (this.enemy_x > 4000 || this.enemy_x < 0){
                    this.enemy_dead = true;
                }
            }
    },
