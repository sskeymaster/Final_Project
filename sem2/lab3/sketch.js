...
function setup(){
    ...
    floor = {
        ...
        drawFloor: function(){
            noStroke();
            fill(this.color);
            rect(0, height - this.visualHeight, width, this.visualHeight);
        }
    };
    ...
    shadows = {
        ...
        drawShadow: function() {
            ...
            if (this.game_start && !this.enemy_dead && !window_object.game_over){
                ...
                if ((gameChar.gameChar_x < this.enemy_x + this.enemy_width && gameChar.gameChar_x + gameChar.width > this.enemy_x && gameChar.gameChar_y + gameChar.height > height - (this.enemy_height + floor.visualHeight))) {
                    gameChar.deadSound();
